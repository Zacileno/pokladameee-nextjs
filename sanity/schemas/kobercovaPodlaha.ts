...
export const kobercovaPodlahaSchema = defineType({
  name: 'kobercovaPodlaha',
  title: 'Podstránka: Kobercová podlaha',
  type: 'document',
  groups: [
  ...
  preview: { prepare: () => ({ title: 'Podstránka: Kobercová podlaha' }) },
})
