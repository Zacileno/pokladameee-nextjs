...
export async function POST(req: NextRequest) {
  ...
  if (isPrihlaska) {
    ...
    await resend.emails.send({
      ...
      to: ['adam.hajdusek@pokladameee.cz', 'lucie.durcakova@pokladameee.cz'],
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px;">
          ...
          <div style="background: #f8f7f5; padding: 32px; border-radius: 0 0 8px 8px; border: 1px solid #efefed; border-top: none;">
            ...
            <div style="background: white; border-radius: 8px; padding: 20px 24px; border: 1px solid #efefed; margin-bottom: 24px;">
              ...
              <a href="tel:+420790388487" style="color: #154C86; font-weight: 800; font-size: 20px; text-decoration: none;">+420 790 388 487</a>
  ...
  if (!webhookOk && !adamEmailOk) {
    return NextResponse.json(
      { error: 'Poptávku se nepodařilo doručit. Zavolejte nám prosím přímo na +420 790 388 487.' },
      { status: 502 }
    )
  }
